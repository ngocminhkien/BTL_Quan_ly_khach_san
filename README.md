...
### Trang quản lý phòng     
<img width="1890" height="932" alt="image" src="docs/img_git/room_list.png" />
### Trang quản lý loại phòng 
<img width="1901" height="939" alt="image" src="docs/img_git/room_add.png" />
...
Tạo database:
```bash
CREATE DATABASE IF NOT EXISTS db_quanlykhachsan
