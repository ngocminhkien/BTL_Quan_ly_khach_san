...
<head>
  <title>Mellow - Website Khách sạn</title>
  <meta charset="utf-8">
...
<body>
  ...
  <svg xmlns="http://www.w3.org/2000/svg" style="display: none;">
    ...
    <symbol xmlns="http://www.w3.org/2000/svg" id="twitter" viewBox="0 0 24 24"><path fill="currentColor" d="M22.46 6c-.77.35-1.6.58-2.46.69c.88-.53 1.56-1.37 1.88-2.38c-.83.5-1.75.85-2.72 1.05C18.37 4.5 17.26 4 16 4c-2.35 0-4.27 1.92-4.27 4.29c0 .34.04.67.11.98C8.28 9.09 5.11 7.38 3 4.79c-.37.63-.58 1.37-.58 2.15c0 1.49.75 2.81 1.91 3.56c-.71 0-1.37-.2-1.95-.5v.03c0 2.08 1.48 3.82 3.44 4.21a4.22 4.22 0 0 1-1.93.07a4.28 4.28 0 0 0 4 2.98a8.521 8.521 0 0 1-5.33 1.84c-.34 0-.68-.02-1.02-.06C3.44 20.29 5.7 21 8.12 21C16 21 20.33 14.46 20.33 8.79c0-.19 0-.37-.01-.56c.84-.6 1.56-1.36 2.14-2.23Z"/></symbol>
    <symbol xmlns="http://www.w3.org/2000/svg" id="linkedin" viewBox="0 0 512 512"><path fill="currentColor" d="M444.17 32H70.28C49.85 32 32 46.7 32 66.89v374.72C32 461.91 49.85 480 70.28 480h373.78c20.54 0 35.94-18.21 35.94-38.39V66.89C480.12 46.7 464.6 32 444.17 32Zm-273.3 373.43h-64.18V205.88h64.18ZM141 175.54h-.46c-20.54 0-33.84-15.29-33.84-34.43c0-19.49 13.65-34.42 34.65-34.42s33.85 14.82 34.31 34.42c-.01 19.14-13.31 34.43-34.66 34.43Zm264.43 229.89h-64.18V296.32c0-26.14-9.34-44-32.56-44c-17.74 0-28.24 12-32.91 23.69c-1.75 4.2-2.22 9.92-2.22 15.76v113.66h-64.18V205.88h64.18v27.77c9.34-13.3 23.93-32.44 57.88-32.44c42.13 0 74 27.77 74 87.64Z"/></symbol>
    <symbol id="search" viewBox="0 0 24 24"><path fill="currentColor" fill-rule="evenodd" d="M11.5 2.75a8.75 8.75 0 1 0 0 17.5a8.75 8.75 0 0 0 0-17.5M1.25 11.5c0-5.66 4.59-10.25 10.25-10.25S21.75 5.84 21.75 11.5c0 2.56-.939 4.902-2.491 6.698l3.271 3.272a.75.75 0 1 1-1.06 1.06l-3.272-3.271A10.21 10.21 0 0 1 11.5 21.75c-5.66 0-10.25-4.59-10.25-10.25" clip-rule="evenodd"/></symbol>
    <symbol xmlns="http://www.w3.org/2000/svg" id="plus" viewBox="0 0 16 16"><path d="M8 4a.5.5 0 0 1 .5.5v3h3a.5.5 0 0 1 0 1h-3v3a.5.5 0 0 1-1 0v-3h-3a.5.5 0 0 1 0-1h3v-3A.5.5 0 0 1 8 4z"/></symbol>
        ...
        <div class="d-flex flex-wrap justify-content-between align-items-center">
          <ul class="info d-flex flex-wrap list-unstyled m-0">
            <li class="location text-capitalize d-flex align-items-center me-4" style="font-size: 14px;">
              <svg class="color me-1" width="15" height="15"><use xlink:href="#location"></use></svg>State Road 54 Trinity, Florida
            </li>
            <li class="phone d-flex align-items-center me-4" style="font-size: 14px;">
              <svg class="color me-1" width="15" height="15"><use xlink:href="#phone"></use></svg>+666 333 9999
            </li>
            <li class="time d-flex align-items-center me-4" style="font-size: 14px;">
              <svg class="color me-1" width="15" height="15"><use xlink:href="#email"></use></svg>yourinfo@yourmail.com
            </li>
          </ul>
        </div>
      </div>
      ...
      <div class="container-fluid padding-side">
        <div class="d-flex justify-content-between align-items-center w-100">
          ...
          <button class="navbar-toggler border-0 d-flex d-lg-none order-3 p-2 shadow-none" type="button"
            ...
            <svg class="navbar-icon" width="60" height="60"><use xlink:href="#navbar-icon"></use></svg>
          </button>
            ...
            <div class="offcanvas-body align-items-center justify-content-center">
              <ul class="navbar-nav align-items-center mb-2 mb-lg-0">
                <li class="nav-item px-3">
                  <a class="nav-link active p-0" aria-current="page" href="/BTL/index.php">Trang chủ</a>
                </li>
                <li class="nav-item px-3"><a class="nav-link p-0" href="#">Giới thiệu</a></li>
                <li class="nav-item px-3"><a class="nav-link p-0" href="#">Dịch vụ</a></li>
                <li class="nav-item px-3"><a class="nav-link p-0" href="#">Tin tức</a></li>
                <li class="nav-item px-3"><a class="nav-link p-0" href="#">Liên hệ</a></li>
                
                <?php if (isset($_SESSION['user_logged_in']) && $_SESSION['user_logged_in'] === true): ?>
                    <li class="nav-item px-3">
                        <a class="nav-link p-0 fw-bold text-primary" href="/BTL/views/booking/history.php">
                            <i class="fa-solid fa-clock-rotate-left"></i> Lịch sử & Hủy phòng
                        </a>
                    </li>
                    
                    <li class="nav-item px-3 dropdown">
                        <a class="nav-link p-0 fw-bold text-dark dropdown-toggle" href="#" role="button" data-bs-toggle="dropdown">
                            Chào, <?php echo htmlspecialchars($_SESSION['user_username']); ?>
                        </a>
                        <ul class="dropdown-menu">
                            <?php if ($_SESSION['user_role'] == 1): ?>
                                <li><a class="dropdown-item" href="/BTL/views/dashboard.php">Vào trang quản trị</a></li>
                            <?php endif; ?>
                            <li><a class="dropdown-item" href="/BTL/logout.php">Đăng xuất</a></li>
                        </ul>
                    </li>
        ...
        <div class="row align-items-center m-auto pt-5 px-4 px-lg-0">
          <div class="text-start col-md-6 col-lg-5 col-xl-6 offset-lg-1">
            ...
            <a href="/BTL/views/login.php" class="btn btn-arrow btn-primary mt-3">
              <span>Khám phá phòng <svg width="18" height="18"><use xlink:href="#arrow-right"></use></svg></span>
            </a>
          </div>
          <div class="col-md-6 col-lg-5 col-xl-4 mt-5 mt-md-0">
            ...
            <form id="form" class="form-group flex-wrap bg-white p-5 rounded-4 ms-md-5">
              ...
              <div id="form-check-alert" style="margin-bottom: 15px;"></div>

              <div class="col-lg-12 my-4">
                <label class="form-label text-uppercase">Ngày nhận phòng</label>
                <input type="date" class="form-control" id="check_in_date_public" required>
              </div>
              <div class="col-lg-12 my-4">
                <label class="form-label text-uppercase">Ngày trả phòng</label>
                <input type="date" class="form-control" id="check_out_date_public" required>
              </div>
              
              <div class="col-lg-12 my-4">
                <label class="form-label text-uppercase">Loại phòng</label>
                <select class="form-control" id="room_type_id_public" required>
              ...
              <div class="d-grid">
                <button type="submit" class="btn btn-arrow btn-primary mt-3">
                  <span>Kiểm tra<svg width="18" height="18"><use xlink:href="#arrow-right"></use></svg></span>
                </button>
              </div>
            </form>
  ...
  <section id="about-us" class="padding-large">
    <div class="container-fluid padding-side" data-aos="fade-up">
      ...
      <div class="row align-items-start mt-3 mt-lg-5">
        <div class="col-lg-6">
          <div class="p-5">
            <p>Chào mừng đến với Hotel Mellow...</p>
            <a href="#" class="btn btn-arrow btn-primary mt-3">
              <span>Đọc về chúng tôi <svg width="18" height="18"><use xlink:href="#arrow-right"></use></svg></span>
            </a>
          </div>
          ...
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              ...
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Phòng Grand Deluxe</h4>
                <p class="product-paragraph text-white">...</p>
                </div>
            </div>
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="#">Phòng Grand Deluxe</a></h4>
              <p><span class="text-primary fs-4">$269</span>/đêm</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              ...
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Phòng Gia đình</h4>
                </div>
            </div>
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="#">Phòng Gia đình</a></h4>
              <p><span class="text-primary fs-4">$360</span>/đêm</p>
            </div>
          </div>
          <div class="swiper-slide">
            <div class="room-item position-relative bg-black rounded-4 overflow-hidden">
              ...
              <div class="product-description position-absolute p-5 text-start">
                <h4 class="display-6 fw-normal text-white">Phòng Đôi Hoàn hảo</h4>
                </div>
            </div>
            <div class="room-content text-center mt-3">
              <h4 class="display-6 fw-normal"><a href="#">Phòng Đôi Hoàn hảo</a></h4>
              <p><span class="text-primary fs-4">$450</span>/đêm</p>
            </div>
          </div>
          </div>
  ...
  <section id="gallery" data-aos="fade-up">
    ...
    <p class="text-center col-lg-4 offset-lg-4 mb-5">Khám phá hình ảnh về các phòng nghỉ...</p>
        ...
        <div class="col-md-6 col-xl-4">
          <div class="service mb-4 text-center rounded-4 p-5">
            <div class="position-relative">
              <svg class="color" width="70" height="70"><use xlink:href="#meditation"></use></svg>
              <img src="assets/images/pattern2.png" alt="img" class="position-absolute top-100 start-50 translate-middle z-n1 pe-5">
            </div>
            <h4 class="display-6 fw-normal my-3">Yoga & Thiền</h4>
            <p>Trẻ hóa cơ thể và tâm trí của bạn...</p>
            </div>
        </div>
        </div>
    </div>
  ...
  <section id="blog" class="padding-medium pt-0">
    <div class="container-fluid padding-side" data-aos="fade-up">
      <div class="d-flex flex-wrap align-items-center justify-content-between">
        ...
        <a href="#" class="btn btn-arrow btn-primary mt-3">
          <span>Xem Thêm Tin Tức<svg width="18" height="18"><use xlink:href="#arrow-right"></use></svg></span>
        </a>
      </div>
      <div class="row mt-5">
        <div class="col-md-6 col-lg-4 mb-4">
          <div class="blog-post position-relative overflow-hidden rounded-4">
            ...
            <div class="position-absolute bottom-0 p-5">
              <a href="#"><span class="bg-secondary text-body m-0 px-2 py-1 rounded-2 fs-6">Khách sạn</span></a>
              <h4 class="display-6 fw-normal mt-2"><a href="#">Một ngày trong đời của khách Hotel Mellow</a></h4>
              </div>
          </div>
        </div>
        </div>
    ...
    <div class="container-fluid padding-side padding-small pt-0" data-aos="fade-up">
      <footer class="row">
        <div class="col-md-6 col-lg-3 mb-4 mb-lg-0">
          ...
          <p class="mt-3">Chào mừng đến với Hotel Mellow...</p>
          </div>
          ...
          <form class=" position-relative">
            ...
            <div class="d-grid">
              <button href="#" class="btn btn-arrow btn-primary mt-3">
                <span>Đăng ký ngay<svg width="18" height="18"><use xlink:href="#arrow-right"></use></svg></span>
              </button>
            </div>
          </form>
        </div>
